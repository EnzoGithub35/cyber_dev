...
<div class="red-text"><?php echo htmlspecialchars($errors['emptyE'], ENT_QUOTES, 'UTF-8'); ?></div>
<div class="red-text"><?php echo htmlspecialchars($errors['username'], ENT_QUOTES, 'UTF-8'); ?></div>
<label for="">story title:</label>
<input type="text" name="title" value="<?php echo htmlspecialchars($title, ENT_QUOTES, 'UTF-8'); ?>">
<div class="red-text"><?php echo htmlspecialchars($errors['emptyT'], ENT_QUOTES, 'UTF-8'); ?></div>
<div class="red-text"><?php echo htmlspecialchars($errors['title'], ENT_QUOTES, 'UTF-8'); ?></div>
<label for="">content (you can style your content ;)):</label>
<input type="text" name="content" value="<?php echo htmlspecialchars($content, ENT_QUOTES, 'UTF-8'); ?>">
<div class="red-text"><?php echo htmlspecialchars($errors['emptyI'], ENT_QUOTES, 'UTF-8'); ?></div>
<div class="red-text"><?php echo htmlspecialchars($errors['content'], ENT_QUOTES, 'UTF-8'); ?></div>
<div class="center">
